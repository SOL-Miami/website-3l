                            ...
                            <div class="jx-slider-content">
                            	<div class="container">
                                    <div class="jx-event-box" >
                                     ...
                                     <iframe width="800" height="450" src="https://www.youtube.com/embed/hW097luAbes" frameborder="0" allowfullscreen></iframe>
                                                                            
                                        <!--<div class="jx-event-play">
                                            <a href="" data-rel="prettyPhoto"><i class="fa fa-play"></i></a>
                                        </div>
                                        <div class="jx-event-title-box">
                                            <div class="jx-event-pretitle">2016 Live Love Laugh Tease</div>
...
Through challenging, in depth, interactive, powerful Bible studies marriages and families are being strengthened, restored, encouraged, and renewed. We believe that we can save the family, one marriage at a time.
                    ...
                    <div class="jx-speaker-item">
                        <div class="jx-speaker-photo jx-image-wrapper"><img width="234" height="189" src="http://ievent.janxcode.com/wp-content/uploads/2015/09/team-8-234x189.jpg" class="attachment-speaker-image wp-post-image" alt="team-8" />
                            <div class="jx-speaker-overlayer"></div>
                            <div class="jx-image-hover-info">
                                <div class="jx-speaker-name">Leo Amber</div>
                    ...
                    <div class="jx-speaker-item">
                        <div class="jx-speaker-photo jx-image-wrapper"><img width="234" height="189" src="http://ievent.janxcode.com/wp-content/uploads/2015/09/team-6-234x189.jpg" class="attachment-speaker-image wp-post-image" alt="team-6" />
                            <div class="jx-speaker-overlayer"></div>
                            <div class="jx-image-hover-info">
                                <div class="jx-speaker-name">Taco Lian</div>
                                <div class="jx-speaker-pos">Graphic Analyzer</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="jx-speaker-item">
                        <div class="jx-speaker-photo jx-image-wrapper"><img width="234" height="189" src="http://ievent.janxcode.com/wp-content/uploads/2015/09/team-4-234x189.jpg" class="attachment-speaker-image wp-post-image" alt="team-4" />
                            <div class="jx-speaker-overlayer"></div>
                            <div class="jx-image-hover-info">
                                <div class="jx-speaker-name">Natali Aero</div>
                    ...
                    <div class="jx-speaker-item">
                        <div class="jx-speaker-photo jx-image-wrapper"><img width="234" height="189" src="http://ievent.janxcode.com/wp-content/uploads/2015/09/team-10-234x189.jpg" class="attachment-speaker-image wp-post-image" alt="team-10" />
                            <div class="jx-speaker-overlayer"></div>
                            <div class="jx-image-hover-info">
                                <div class="jx-speaker-name">John Doe</div>
                ...
                <div class="jx-countup ">
                    ...
                    <div class="four columns count-item">
                        ...
                        <div class="jx-counter-item">
                            ...
                            <div class="jx-counter-info">
                                <div class="jx-counter-text">Tickets</div>
                                <div class="jx-counter-number jx-counter-up">2,150</div>
                            </div>
                            <!-- Counter info -->
                        </div>
                    </div>
                    ...
                    <div class="four columns count-item">
                        ...
                        <div class="jx-counter-item">
                            ...
                            <div class="jx-counter-info">
                                <div class="jx-counter-text">Discussions</div>
                                <div class="jx-counter-number jx-counter-up">1,500</div>
                            </div>
                            <!-- Counter info -->
                        </div>
                    </div>
                    ...
                    <div class="four columns count-item">
                        ...
                        <div class="jx-counter-item">
                            ...
                            <div class="jx-counter-info">
                                <div class="jx-counter-text">Subscribers</div>
                                <div class="jx-counter-number jx-counter-up">1,830</div>
                            </div>
                            <!-- Counter info -->
                        </div>
                    </div>
                    ...
                    <div class="four columns count-item">
                        ...
                        <div class="jx-counter-item">
                            ...
                            <div class="jx-counter-info">
                                ...
                                <div class="jx-counter-number jx-counter-up">1,050</div>
                            </div>
                            <!-- Counter info -->
                        </div>
                    </div>
...
<div class="jx-section-title-1 jx-dark">
			...
			<ul class="resp-tabs-list parenttab_1">
				...
				<li class="resp-tab-item">
					<div class="jx-tab-date jx-uppercase">Feb 12</div>
					<div class="jx-tab-day jx-uppercase">7:00 PM</div>
				</li>

				<li class="resp-tab-item">
					<div class="jx-tab-date jx-uppercase">Feb 13</div>
...
*/ ?>
			...
			<div>
				...
				<div class="item">
					<div class="left-position">
					<div class="image"><img src="http://ievent.janxcode.com/wp-content/uploads/2015/09/team-8.jpg" alt=""></div>
					<!-- Image -->
					</div>
					<!-- Left item Position -->
				...
				<div class="item">
					<div class="left-position">
					<div class="image"><img src="http://ievent.janxcode.com/wp-content/uploads/2015/09/team-9.jpg" alt=""></div>
					<!-- Image -->
					</div>
					<!-- Left item Position -->
        ...
        <div  class="jx-container container-no-margin jx-padding  ">
				...
				<div class="container ">
                    <div class="jx-section-title-1 jx-dark">
                        ...
                        <div class="jx-subtitle"><p>Phasellus lectus justo, vestibulum gravida tortor nec, sagittis efficitur risus. In dignissim laoreet venenatis. Nullam tempus sem est, nec tincidunt nisl semper euismod</p></div>
                        <!-- Section Title -->

                    </div>

                    <div class="jx-interactive-map">
                        <div class="jx-inter-map">
                            <img src="http://janxcode.com/ievent/images/exhibition-floor.png" alt="">
                            <ul>
                                ...
                                <h2>Section A</h2>
                                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae distinctio esse placeat minus fugit, voluptate, quos, ea, nisi temporibus repudiandae perspiciatis natus quasi ipsa corrupti ipsum amet facere ut nihil.</p>
        	...
        	<div class="container">
                ...
                <div class="jx-media-center">
                    ...
                    <div class="one-third columns">
                        ...
                        <!-- Image -->
                        <div class="title"><a href="#1">Lorem ipsum dolor sit amet consectet</a></div>
                        <!-- Title -->
                    ...
                    <div class="one-third columns">
                        ...
                        <!-- Image -->
                        <div class="title"><a href="#2">Lorem ipsum dolor sit amet consectet</a></div>
                        <!-- Title -->
                        <div class="date"><i class="line-icon icon-calendar"></i> <span>25 Jan 2015</span> <i class="line-icon icon-location"></i> <span>London</span></div>
                        <!-- Date -->
                        <div class="description">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. ips dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</div>
                    ...
                    <div class="one-third columns">
                        ...
                        <!-- Image -->
                        <div class="title"><a href="#3">Lorem ipsum dolor sit amet consectet</a></div>
                        <!-- Title -->
                        <div class="date"><i class="line-icon icon-calendar"></i> <span>25 Jan 2015</span> <i class="line-icon icon-location"></i> <span>London</span></div>
                        <!-- Date -->
                        <div class="description">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. ips dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</div>
       	...
       	<div  class="jx-container container-no-margin   jx-countdown-form">
				...
				<div class="container ">
                    ...
                    <div class="jx-ticket-form jx-half-width left">
                        ...
                        <form action="http://ievent.janxcode.com/2015/08/26/fringilla-vel-aliquet-nec-vulputate/" id="contactForm-9" method="post">

                        <div class="jx-ticket-first-name">
                        <input type="text" id="name-contactform-9" name="reg_name" placeholder="Full Name" class="jx-form-text" />
                        <!-- First Name Textbox -->
                        </div>
                        <div class="jx-ticket-email">
                        <input type="text" id="email-contactform-9" name="reg_email" placeholder="Email Address" class="jx-form-text" data-validation-length="email" data-validation="required"/>
                        <!-- Email Name Textbox -->
                        </div>


                        <div class="jx-ticket-phone">
                        <input type="text" id="subject-contactform-9" name="reg_phone" placeholder="Phone Number" class="jx-form-text" />
                        <!-- Phone Textbox -->
                        </div>
                        ...
                        <div class="jx-ticket-type">
                            <select name="reg_ticket_type" class="select-box">
                        ...
                        <div class="jx-ticket-valid">
                            <select name="reg_ticket_valid" class="select-box">
                        ...
                        <input type="submit" id="submit-register-9" name="submit-register-9" class="jx-form-btn jx-btn-default" value="REGISTER NOW" />
                        <!-- Submit Button -->
                        </form>
                        </div>
                        <!-- EOF Ticket Form -->
        ...
        <div  class="jx-container container-no-margin  jx-grey-bg ">
               ...
               <?php /*     <li><div class="jx-testimonial-item">
                                ...
                                <div class="jx-testimonial-content">
                                    <div class="jx-name"><i class="fa fa-quote-left"></i><span>John Doe</span></div>
                                    <div class="jx-content"><p>Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa qui. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p></div>
        ...
        <div id='sponsors' class="jx-container container-no-margin jx-padding jx-white-bg ">
            ...
            <div class="container ">
                <div class="jx-section-title-1 jx-dark">
                    ...
                    <div class="jx-title jx-uppercase">Partners</div>
                ...
                <div class="jx-sponsors">
                    <ul>
                        <li><a href=""><div class="slide-contents"><img src="http://ievent.janxcode.com/wp-content/uploads/2015/09/logo-1.png" alt=""></div></a></li>
                        <li><a href=""><div class="slide-contents"><img src="http://ievent.janxcode.com/wp-content/uploads/2015/09/logo-2.png" alt=""></div></a></li>
                        <li><a href=""><div class="slide-contents"><img src="http://ievent.janxcode.com/wp-content/uploads/2015/09/logo-3.png" alt=""></div></a></li>
                        <li><a href=""><div class="slide-contents"><img src="http://ievent.janxcode.com/wp-content/uploads/2015/09/logo-6.png" alt=""></div></a></li>
                        <li><a href=""><div class="slide-contents"><img src="http://ievent.janxcode.com/wp-content/uploads/2015/09/logo-5.png" alt=""></div></a></li>
                    </ul>
                </div>
						...
						<li class="one-third columns">
							<div class="jx-subscribe-event">
								...
								<form method="post" action="#">
									...
									<input type="submit" name="jx-newsltter-submit" value="Submit" />
									</div>
								</form>
							</div>
						</li>
    ...
    <footer class="jx-footer-section jx-container">
        ...
        <div class="jx-footer-widget">
        	...
        	<?php /* Comment data not needed
                    ...
                    <div class="four columns">		<div class="jx-footersection-widget"><div id="recent-posts-5" class="widget widget_recent_entries">		<div class="sub"><header><h4>Recent Posts</h4><div class="jx-right-pattern"></div></header></div>		<ul>
					<li>
				<a href="http://ievent.janxcode.com/2015/09/01/this-is-a-new-post/">Vulputate eleifend tellus</a>
						</li>
					<li>
				<a href="http://ievent.janxcode.com/2015/08/26/amet-consectetuer-adipiscing-elit/">Amet consectetuer adipiscing elit</a>
						</li>
					<li>
				<a href="http://ievent.janxcode.com/2015/08/26/fringilla-vel-aliquet-nec-vulputate/">Fringilla vel aliquet nec vulputate</a>
						</li>
					<li>
				<a href="http://ievent.janxcode.com/2015/08/26/aenean-vulputate-eleifend-tellus/">Aenean vulputate eleifend tellus</a>
						</li>
				</ul>
		</div></div></div>
                    <!-- Widget#1 -->

                    <div class="four columns"><div class="jx-footersection-widget"><div id="tag_cloud-3" class="widget widget_tag_cloud"><div class="sub"><header><h4>Tags</h4><div class="jx-right-pattern"></div></header></div><div class="tagcloud"><a href='http://ievent.janxcode.com/tag/conference/' class='tag-link-11' title='11 topics' style='font-size: 8pt;'>Conference</a>
<a href='http://ievent.janxcode.com/tag/exhibition/' class='tag-link-15' title='11 topics' style='font-size: 8pt;'>Exhibition</a>
<a href='http://ievent.janxcode.com/tag/international/' class='tag-link-13' title='11 topics' style='font-size: 8pt;'>International</a>
<a href='http://ievent.janxcode.com/tag/seminar/' class='tag-link-12' title='11 topics' style='font-size: 8pt;'>Seminar</a>
<a href='http://ievent.janxcode.com/tag/workshop/' class='tag-link-14' title='11 topics' style='font-size: 8pt;'>Workshop</a></div>
</div></div></div>
                    <!-- Widget#1 -->

                    <div class="four columns"><div class="jx-footersection-widget"><div id="archives-4" class="widget widget_archive"><div class="sub"><header><h4>Archives</h4><div class="jx-right-pattern"></div></header></div>		<ul>
	<li><a href='http://ievent.janxcode.com/2015/09/'>September 2015</a></li>
	<li><a href='http://ievent.janxcode.com/2015/08/'>August 2015</a></li>
		</ul>
</div></div></div>
                    <!-- Widget#1 -->
            </div>
